		...
		var resData = {
				...
				"gotest":{
					...
					content:{
						...
						time: [0.04, 0.009, 0.505, 0.008, 0.09, 0.09, 0.008, 0.01, 0.101, 0.013, 0, 0],
						cover: [49.4, 23.4, 65.2, 22, 90.6, 45.7, 55.8, 66.7, 70.4, 6.2, 0, 0],
						noTest: ["/gocheck", "/gocheck/structcheck", "/gocheck/structcheck"]
					}
				},
				//代码风格
				codeStyle: {
